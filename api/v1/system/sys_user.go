...
import (
	...
	systemReq "github.com/zouchangfu/QanLong/model/system/request"
	systemRes "github.com/zouchangfu/QanLong/model/system/response"
...
func (b *BaseApi) Register(c *gin.Context) {
	...
	// 对数据进行校验
	// utils.RegisterVerify 是校验地规则，我觉得这里可以通过tag地方式来做校验
	if err := utils.Verify(r, utils.RegisterVerify); err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}

	// 把前端传过来地角色数据写到authorities中
	...
	// 创建对象，复制数据到 SysUser 中，这里可以通过写一个复制地工具来复制数据
	...
	// 把数据写到数据库中，userService 这个是什么时候创建对象的
